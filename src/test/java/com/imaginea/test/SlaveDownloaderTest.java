...
public class SlaveDownloaderTest {
  ...
  public void testLinksPointingToMails() throws IOException {
    ...
    final TestActorRef<SlaveDownloader> ref = TestActorRef.create(actorSystem,
        props, "Test SlaveDownloader - findLinksPointingToMails");
    final SlaveDownloader actor = ref.underlyingActor();
    assertTrue(actor
        .findLinksPointingToMails(
            "http://mail-archives.apache.org/mod_mbox/maven-users/201506.mbox/browser")
        .size() == 24);
  }
